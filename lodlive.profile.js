...
$.jStorage.set('profile', {
	...
	'connection' : {
		...
		'http://localhost:8080/marmotta/' : {
			description : {
				en : 'This is a sparql endpoint for Marmotta'
			},
			useForInverseSameAs : true,
			/*change this*/
			endpoint : 'http://localhost:8080/marmotta/sparql',
			examples : [{
				label : 'earth-space-elevator-construction',
				uri : 'http://localhost:8080/marmotta/ldp/isaportal3/earth-space-elevator-construction'
			}, {
				label : 'iss-3d-printingrepair',
				uri : 'http://localhost:8080/marmotta/ldp/isaportal3/iss-3d-printingrepair'
			}]
		}
	},
	'http://dbpedia.org' : {
